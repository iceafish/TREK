...
import { Plane, LogOut, Settings, ChevronDown, Shield, ArrowLeft, Users, Moon, Sun, Monitor, CalendarDays, Briefcase, Globe, Compass, BookOpen, Bookmark, Github } from 'lucide-react'
                  ...
                  {appVersion && (
                    <div className="px-4 pt-2 pb-2.5 text-center border-t border-edge-secondary" style={{ marginTop: 4 }}>
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                        ...
                        {/* No Discord on this fork — the pill links to the repo instead. */}
                        <a href={REPO_URL} target="_blank" rel="noopener noreferrer"
                          ...
                          onMouseEnter={e => e.currentTarget.style.background = '#24292F20'}
                          onMouseLeave={e => e.currentTarget.style.background = 'var(--bg-tertiary)'}
                          title="GitHub">
                          <Github size={12} color="var(--text-faint)" />
                        </a>
                      </div>
                    </div>
                  )}
