...
const settings: TranslationStrings = {
  ...
  'settings.mapAmapOfflineHint': 'La mappa di base AMap non supporta il download di mappe offline.',
  'settings.mapAmapSubtitle': 'AMap — mappa di base della Cina continentale',
