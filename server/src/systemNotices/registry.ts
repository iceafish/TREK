 ...
 *
 * `release-4-0-0` and `thank-you-support` carried upstream's release announcement
 * and funding CTAs (Buy Me a Coffee / Ko-fi); this fork retired them rather than
 * showing another project's maintainer note and donation links to its users.
 */
