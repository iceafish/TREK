...
```bash
pnpm install
pnpm run build        # tsc ESM build + tsc CJS build + scripts/finish-cjs.mjs
pnpm run typecheck    # tsc --noEmit
pnpm test             # vitest run
pnpm exec vitest run test/sdk.test.ts        # single test file
